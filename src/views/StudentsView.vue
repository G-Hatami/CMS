<template>
  <models-list :items="items" :headers="headers" search-placeholder="search in students" @create-item="addDialog = true"
    ...
    <template #models-name>{{t("students.Students")}}</template>
    <template #model-name>{{t("students.AddStudent")}}</template>
  </models-list>
...
const {t} = useI18n()
const headers = ref([
  {title: t('students.headers.StudentID'), value: 'studentId', key: 'studentId'},
  {title: t('students.headers.Firstname'), value: 'firstname', key: 'firstname'},
  {title: t('students.headers.Lastname'), value: 'lastname', key: 'lastname'},
  {title: t('students.headers.NationalNumber'), value: 'nationalNumber', key: 'nationalNumber'},
  {title: t('students.headers.Address'), value: 'address', key: 'address'},
  {title: t('students.headers.Faculty'), value: 'faculty', key: 'faculty'},
  {title: t('students.headers.Actions'), value: 'actions'}
])
